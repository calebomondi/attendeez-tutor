    ...
    <>
      {
        data.length > 0 ? (
          data.map((item,index) => (
            <div className="bg-base-200 border border-teal-500 rounded-lg w-full flex flex-col md:flex-row md:justify-between md:items-center p-2 shadow-none hover:text-teal-500 hover:shadow-[0_0_10px_5px_rgba(0,128,128,0.85)] hover:bg-base-200 transition-shadow transition-colors duration-300" key={index} onClick={() => handleClick()}>
