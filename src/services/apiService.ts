...
const apiService = {
  getMyClassesToday: async (teacher_id: string): Promise<MyClassesToday[]> => {
    try {
      const response: AxiosResponse<MyClassesToday[]> = await axios.get(`${API_URL}/myclasses-today?teacher_id=${teacher_id}`);
  ...
  geAttendanceStats: async (unit_id: string): Promise<AttendedStats[]> => {
    try {
      const response: AxiosResponse<AttendedStats[]> = await axios.get(`${API_URL}/attendance-stats?unit_id=${unit_id}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching data:', error);
      throw error;
  ...
  getAttendanceSummary: async (unit_id: string): Promise<AttendedSummary[]> => {
    try {
      const response: AxiosResponse<AttendedSummary[]> = await axios.get(`${API_URL}/attendance-summary?unit_id=${unit_id}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching data:', error);
      throw error;
  ...
  getTeacherInfo: async (email: string): Promise<TeacherInfo> => {
    try {
      const response: AxiosResponse<TeacherInfo> = await axios.get(`${API_URL}/teacher-info?email=${email}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching data:', error);
      throw error;
  ...
  postStartClassSession: async (unit_id:string): Promise<StartClassSession> => {
    try {
      const response: AxiosResponse<StartClassSession> = await axios.post(`${API_URL}/start-classsession?unitId=${unit_id}`);
  ...
  putEndClassSession: async (unit_id:string): Promise<EndClassSession> => {
    try {
      const response: AxiosResponse<EndClassSession> = await axios.put(`${API_URL}/finish-classsession?unitId=${unit_id}`);
  ...
  isClassActive: async (unit_id:string): Promise<ClassIsActive> => {
    try {
      const response: AxiosResponse<ClassIsActive> = await axios.get(`${API_URL}/active-session?unitId=${unit_id}`);
  ...
  uploadSingleStudent: async (unit_id:string,student_id:string): Promise<UploadSingle> => {
    try {
      const response: AxiosResponse<UploadSingle> = await axios.post(`${API_URL}/upload-single?unitId=${unit_id}&studentId=${student_id}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching data:', error);
      throw error;
